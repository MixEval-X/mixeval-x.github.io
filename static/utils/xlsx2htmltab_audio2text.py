...
meta_dicts = {
    ...
    'Qwen2-Audio-7B-Instruct': {'url': 'https://huggingface.co/Qwen/Qwen2-Audio-7B-Instruct'},
    'Qwen2-Audio-7B': {'url': 'https://huggingface.co/Qwen/Qwen2-Audio-7B'},
    'SALMONN-13B': {'url': 'https://github.com/bytedance/SALMONN'},
    'Qwen-Audio': {'url': 'https://huggingface.co/Qwen/Qwen-Audio'},
    'Qwen-Audio-Chat': {'url': 'https://huggingface.co/Qwen/Qwen-Audio-Chat'},
    'SALMONN-7B': {'url': 'https://github.com/bytedance/SALMONN'},
...
generate_html_table('data/audio2text.xlsx', 'static/utils/output_html_tab_audio2text.html', 'tab_audio2text')
