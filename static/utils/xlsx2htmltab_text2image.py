...
meta_dicts = {
    'Flux': {'url': 'https://flux-ai.io/?gad_source=1&gclid=Cj0KCQjwsc24BhDPARIsAFXqAB3kLEprxA4M3f1o0PeoIzg2zXA-3iN8G-FNTl9rw8CJ02EUi-dD3LAaAidrEALw_wcB'},
    'DALL·E 3 HD': {'url': 'https://openai.com/index/dall-e-3/'},
    'PixArtAlpha': {'url': 'https://github.com/PixArt-alpha/PixArt-alpha'},
    'PlayGround V2.5': {'url': 'https://playground.com/blog/playground-v2-5'},
    'PlayGround V2': {'url': 'https://playground.stream/en'},
    'SD3': {'url': 'https://stability.ai/news/stable-diffusion-3'},
    'Stable Cascade': {'url': 'https://huggingface.co/spaces/multimodalart/stable-cascade'},
    'SD1.5': {'url': 'https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-v1-5'},
    'SDXL': {'url': 'https://huggingface.co/docs/diffusers/en/using-diffusers/sdxl'}
}
...
generate_html_table('data/text2image.xlsx', 'static/utils/output_html_tab_text2image.html', 'tab_text2image')
